...
data_1 = scipy.io.loadmat('./data/mat_data/gen_1_data.mat')
data_2 = scipy.io.loadmat('./data/mat_data/gen_2_data.mat')
data_3 = scipy.io.loadmat('./data/mat_data/gen_3_data.mat')


t = data_1['t'].flatten()[:,None]
x1 = data_1['x1'].flatten()[:,None]
x2 = data_2['x2'].flatten()[:,None]
x3 = data_3['x1'].flatten()[:,None]
...
time = np.linspace(t_min, t_max, len(u_star_flattened))
